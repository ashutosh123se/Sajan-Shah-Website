        ...
        <div className="bg-gradient-to-r from-gray-900/50 to-black border border-gray-800 rounded-[3rem] p-12 md:p-20 flex flex-col lg:flex-row items-center gap-16">
          <div className="lg:w-2/3">
            ...
            <div className="flex flex-wrap gap-6">
              {[
                { t: "Annual Impact Report", s: "4.2 MB", c: "bg-[#f26522]" },
                { t: "ESG Compliance Report", s: "2.1 MB", c: "bg-gray-700" }
              ].map((doc, idx) => (
                <button key={idx} className="flex items-center gap-4 bg-white/5 hover:bg-white/10 text-white border border-white/10 px-8 py-5 rounded-2xl transition-all group">
                  <span className={`w-10 h-10 rounded-lg ${doc.c} flex items-center justify-center text-[10px] font-bold group-hover:scale-110 transition-transform`}>PDF</span>
