...
export const PartnersWall: React.FC = () => {
  return (
    <section className="py-40 bg-[#050505]">
      <div className="w-full">
        <div className="text-center">
          <h3 className="text-xl md:text-3xl font-bold text-gray-800 uppercase tracking-[0.6em] mb-16">Institution Partners</h3>
