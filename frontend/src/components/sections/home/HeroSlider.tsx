...
export const HeroSlider: React.FC = () => {
  ...
  return (
    <section className="relative h-screen min-h-[700px] overflow-hidden bg-black flex items-center justify-center">
      ...
      {/* Content with optimized space management to balance the cinematic layout */}
      <div className="relative z-20 w-full px-4 sm:px-6 lg:px-8 text-center max-w-6xl mx-auto pb-24 md:pb-32">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-white mb-6 leading-[1.15] tracking-tight drop-shadow-2xl animate-fade-in-up" style={{ textShadow: '0 4px 20px rgba(0,0,0,0.8)' }}>
          {slide.headline}
        </h1>
        <p className="text-xl md:text-2xl font-light text-gray-200 mb-10 max-w-3xl mx-auto drop-shadow-md animate-fade-in-up animation-delay-200 leading-relaxed">
          {slide.subheadline}
        </p>
