...
export const Footer: React.FC = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/sajan-shah-7840244a/",
  ...
  return (
    <footer className="bg-black text-white pt-24 pb-12 border-t-8 border-[#f26522] z-40 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-gray-600 text-xs uppercase tracking-widest font-light">
            © {currentYear} RiseX Sajan Shah. All rights reserved.
          </p>
        </div>
      </div>
