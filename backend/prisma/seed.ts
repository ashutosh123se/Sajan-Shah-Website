  ...
  },
  {
    ...
    content: (() => {
      ...
      try {
        ...
        const { DEFAULT_IMPACT_STORIES } = require('../src/utils/impactStoryDefaults');
        return DEFAULT_IMPACT_STORIES;
      } catch {
        return {
          ...
          stories: [
            {
              ...
              bodyHtml: '<p>See Admin → Contributions → Impact Case Stories to edit full story content.</p>',
            },
          ],
        };
      }
