/**
 * Impact Stories CMS defaults — mirrors frontend/src/lib/impactStoryDefaults.ts
 * Used by seed + sync scripts so admin/CMS starts with the live frontend copy.
 */
...
const DEFAULT_GALLERY_PHOTOS = [
  { cat: 'Food & Aid', title: 'Neighborhood Relief', imageUrl: '/Social Work/1.jpeg' },
  { cat: 'Community Support', title: 'COVID-19 Relief Drive', imageUrl: '/Social Work/2.jpeg' },
  { cat: 'Awareness Campaign', title: 'Community Interaction', imageUrl: '/Social Work/3.jpeg' },
  { cat: 'Public Action', title: 'Media & Awareness', imageUrl: '/Social Work/4.jpeg' },
  { cat: 'Safety Drive', title: 'Empowering Sanitation Workers', imageUrl: '/Social Work/5.jpeg' },
  { cat: 'Local Support', title: 'Empowering Street Vendors', imageUrl: '/Social Work/6.jpeg' },
  { cat: 'Sanitation Support', title: 'Assisting Frontline Workers', imageUrl: '/Social Work/7.jpeg' },
  { cat: 'Welfare Drive', title: 'Nighttime Aid Distribution', imageUrl: '/Social Work/8.jpeg' },
  { cat: 'Animal Welfare', title: 'Supporting Gaushalas', imageUrl: '/Social Work/9.jpeg', pos: 'object-left' },
  { cat: 'Youth Outreach', title: 'Mega Yoga Session', imageUrl: '/Social Work/10.jpeg', pos: 'object-right' },
  { cat: 'Community Engagement', title: 'Slum Outreach', imageUrl: '/Social Work/11.jpeg', pos: 'object-bottom' },
  { cat: 'Appreciation Drive', title: 'Honoring Local Workers', imageUrl: '/Social Work/12.jpeg', pos: 'object-left' },
  { cat: 'Safety Drive', title: 'Distributing Safety Gear', imageUrl: '/Social Work/13.jpeg' },
  { cat: 'Food & Aid', title: 'Street Food Distribution', imageUrl: '/Social Work/14.jpeg' },
  { cat: 'Volunteer Action', title: 'Youth Relief Team', imageUrl: '/Social Work/15.jpeg' },
  { cat: 'Hunger Relief', title: 'Midnight Food Drive', imageUrl: '/Social Work/16.jpeg' },
];

module.exports = { DEFAULT_IMPACT_STORIES, DEFAULT_GALLERY_PHOTOS };
