 ...
 * Updates media + CTA URLs only — does not invent new section copy.
 * Safe to run on production so the live site matches local designer assets/links.
 */
...
export async function alignCmsToFrontendDefaults(): Promise<{
  ...
  // HOME — hero slides (local designer CMS images + frontend CTA links)
  ...
  // HOME — SplitHero (frontend SplitHero.tsx defaults)
  ...
  // HOME — Brand write-up background (frontend BrandWriteUp.tsx default)
  ...
  // ABOUT — bio portrait (frontend AboutBio.tsx default)
  ...
  // ABOUT — movement images (frontend AboutMovement.tsx defaults)
  ...
  // SPEAKING — hero image + buttons (designer CTAs)
