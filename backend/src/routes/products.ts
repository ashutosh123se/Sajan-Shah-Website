...
// Protected routes
router.post('/', verifyToken, requireRole('SUPER_ADMIN', 'ADMIN', 'EDITOR', 'SHOP_MANAGER'), createProduct);
router.put('/:id', verifyToken, requireRole('SUPER_ADMIN', 'ADMIN', 'EDITOR', 'SHOP_MANAGER'), updateProduct);
